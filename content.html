        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-body shadow shadow">
                    ...
                    <img src="img/com.png" class="card-img-top" id="imgcontent">
                </div>
            </div>
        </div>
        <div class="col-lg">
            <div class="card">
                <div class="card-body shadow shadow">
                    ...
                    <img src="Picture1.png" class="card-img-top" id="imgcontent">
                </div>
            </div>
        </div>
        <div class="col-lg">
            <div class="card">
                <div class="card-body shadow shadow">
                    ...
                    <img src="pngegg.png" class="card-img-top" id="imgcontent">
                </div>
            </div>
        </div>
    </div>
